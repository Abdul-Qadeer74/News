...
const Entertainment = () => {
  ...
  useEffect(() => {
    const getUsers = async () => {
      const response = await fetch(
        "https://newsapi.org/v2/top-headlines?country=us&category=entertainment&apiKey=22439b547d904b1caa169221d47072f8",
      );
  ...
  return (
    <div className="w-full p-2">
      <h1 className="text-6xl font-bold w-full  flex items-center ">
        Entertainment
      </h1>
      {articles.length > 0 && (
